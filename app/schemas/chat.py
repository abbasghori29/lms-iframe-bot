...
class ChatRequest(BaseModel):
    """Chat request schema — supports text, images, or both"""
    question: str = Field(default="", description="User's question (can be empty if image-only)")
    ...
    image_data: Optional[str] = Field(
        default=None,
        description="Base64-encoded image data (supports PNG, JPEG, GIF, WebP)"
    )
